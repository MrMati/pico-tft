...
int main()
{
  ...
  //printf((uint16_t)__data_load_end, HEX);
  //printf(" RAM=0x");
  //printf((uint16_t)_end - (uint16_t)__data_start, HEX);
  printf("Benchmark                Time (microseconds)\n");

  uint32_t usecHaD = testHaD();
  printf("HaD pushColor             %ld\n", usecHaD);
  delay(100);
